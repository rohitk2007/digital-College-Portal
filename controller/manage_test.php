...
<div class="row">
      <table class="table">
        ...
        <tbody id="myTable1">
          ...
          <td><input type="button" class="btn btn-sm btn-success" name="" value="Active" onclick="manage_slider_active('<?php echo $pid?>')">
              <input type="button" class="btn btn-sm btn-danger ml-2" name="" value="Deactive" onclick="manage_slider_deactive('<?php echo $pid?>')">

               <a href="add_question.php?testid=<?php echo $row["test_id"] ?>" class="btn btn-sm btn-info ml-2 mt-2">Add More Question</a>
  ...
  <!-- /.content-wrapper -->
<form method="post" action="test_status.php" id="updateform">
