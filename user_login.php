    ...
    <body>
        ...
        <div class="pt-5 pb-5">
            <div class="text-center">
                <img src="user.svg" height="150" width="150"></img>
            </div>
            
            <form class="mt-5" id="loginform" method="post" action="validate_login.php">
                
                <div class="input-group mb-2 px-2">
                <div class="input-group-prepend">
                <div class="input-group-text"><i class="icofont-user"></i></div>
                </div>
                ...
                <div class=" mb-2 px-2 py-3">
                    <input type="button"  class="form-control btn btn-info"  value="LOGIN NOW" onclick="check()" style=";color:white;font-weight: bold">
                </div>
	  ...
	  <td align="left"><a href="registration.php" class="btn btn-info"><span style="font-size:12px;color:#000000;font-weight: bold;">CREATE ACCOUNT<span></a></td>
          <td align="right"><a href="forgetpassword.php" class="btn btn-info"><span  style="font-size:12px;color:#000000;font-weight: bold;">FORGET PASSWORD<span></a></td>
       	  </tr>
	  </table>
