...
<div class="text-center">
  <h4>Add Course</h4>
  <form method="post" action="add_course.php" id="course_form" enctype="multipart/form-data">

     <input type="hidden" name="mp_id" id="mp_id">
    <div class="form-group mb-3">
      <input type="text" class="form-control" name="c_name" id="c_name" placeholder="course title">
    </div>
     <div class="form-group mb-3">
      <input type="text" class="form-control" name="c_duration" id="c_duration" placeholder="course duration in month">
    </div>
     <div class="form-group mb-3">
      <input type="text" class="form-control" name="c_fee" id="c_fee" placeholder="course fee">
    </div>
    <!--
     <div class="form-group mb-3">
...
-->
    ...
    <div class="text-right">
      <input type="button" class="btn btn-success btn-sm" value="Add Course" onclick="add_course()">
    </div>
