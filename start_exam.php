...
<html lang="en">
    <head>
     ...
     <body>
        ...
        <main id="main">
            <div class="container" >
                <form method="post" id="formtest" action="submit_test.php">
                <div>
...
$cntr=0;
         $sql="select * from question where test_id=".$testid." order by question_id";
              $result = $con->query($sql);
             if ($result->num_rows > 0) {
        ...
        <p>
            ...
            <div class="form-group">
                <input type="radio" name="" id="<?php echo $oa ?>" onclick="changeoption(1,<?php echo $cntr ?>)"> <?php echo $row["option_a"]?>
            </div>
            <div class="form-group">
                <input type="radio" name="" id="<?php echo $ob ?>" onclick="changeoption(2,<?php echo $cntr ?>)"> <?php echo $row["option_b"]?>
            </div>
            <div class="form-group">
                <input type="radio" name="" id="<?php echo $oc ?>" onclick="changeoption(3,<?php echo $cntr ?>)"> <?php echo $row["option_c"]?>
            </div>
            <div class="form-group">
                <input type="radio" name="" id="<?php echo $od ?>" onclick="changeoption(4,<?php echo $cntr ?>)"> <?php echo $row["option_d"]?>
            </div>
            ...
            <div class="container">
                <table align="center" style="width:100%;font-size:20px;">
                    <tr align=center>
                        ...
                        <td id="display" style="color:white"></td>
                        <td><input type="button" class="btn btn-sm btn-success" name="" value="Submit Test" onclick="submit_test()"></td>
...
<script type="text/javascript">
    function clearoption(qid)
    {
        ...
        document.getElementById(qns).value="C";
    ...
    function saveoption(qid)
    {
        ...
        {
            document.getElementById(qns).value="A";
            document.getElementById("msg").innerHTML = "Answer save successfully";
            $('#myModal').modal('show');

        }
        else if(document.getElementById(ob).checked==true)
        {
            document.getElementById(qns).value="B";
            document.getElementById("msg").innerHTML = "Answer save successfully";
            $('#myModal').modal('show');
        }
        ...
        {
            document.getElementById(qns).value="D";
            document.getElementById("msg").innerHTML = "Answer save successfully";
            $('#myModal').modal('show');
        }
        else
