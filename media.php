...
<html lang="en">
    ...
    <body>
        ...
        <header id="header" class=" header fixed-top" style="background-color:#D35400">
            <div class="container">
                ...
                <div class="logo text-center">
                    <p class="appname">
                        <a class=" mr-3"><b>RAJMUDRA ONLINE CLASSES</b></a>
                    </p>
            ...
            while($row = $result->fetch_assoc()) 
              {
                $cid=$row["course_id"];
                    ...
                    $sql1="select * from lecture_video where course_id=".$cid." AND status='Active' order by lecture_video_id desc";
                  $result1 = $con->query($sql1);
                 if ($result1->num_rows > 0) {

                while($row1 = $result1->fetch_assoc()) 
                  {
                    $path="controller/lecture_video/".$row1["video_path"];
        ...
        <h6  align="center"><?php echo $row2["course_name"] ?></h6>
            ...
            <div class="container">
                <table align="center" style="width:100%;font-size:20px;">
                    <tr align=center>
                        ...
                        <td><a href="media.php?rid=<?php echo $rid ?>"><i class="icofont-youtube-play pl-1 active"><span style="font-size:12px;"><p class="f">Media</p></span></i></a></td>
