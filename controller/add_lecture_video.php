...
if(move_uploaded_file($_FILES['gallery_file']['tmp_name'],$target_path))
{
              ...
              $id=$id+1;
              $query = "INSERT INTO lecture_video(lecture_video_id,upload_date,course_id,video_title,video_description,video_path,status) VALUES('".$id."','".$u_date."',".$cid.",'".$title."','".$description."','".$cname."','Active')";

              mysqli_query($link,$query);
              echo '<script type="text/javascript">';
              echo ' alert("video upload Successfully")';  
              echo '</script>';
              include "gallery.php";
            }
