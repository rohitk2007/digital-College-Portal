...
<div class="row">
      ...
      <table class="table">
        ...
        <tbody id="myTable">
          ...
          <td><?php echo $row["total_fees"]?><br></td>
          <td><?php echo $row["status"]?><br></td>
          
          
          
          <td><input type="button" class="btn btn-sm btn-success" name="" value="Fee Paid" onclick="manage_fee_paid('<?php echo $pid?>')">
  ...
  <!-- /.content-wrapper -->
<form method="post" action="fees_status_update.php" id="updateform">
...
<script type="text/javascript">
    function manage_fee_paid(pid)
    {
      //alert(pid);
      document.getElementById('pid').value=pid;
      document.getElementById('actionid').value="paid";
