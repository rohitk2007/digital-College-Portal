...
<html lang="en">
    <head>
     ...
     <body>
        ...
        <main id="main">
            <div class="container" >
                <caption class="mt-3">Available Documents</caption>
                <div>
            ...
            while($row = $result->fetch_assoc()) 
              {
                $cid=$row["course_id"];
                    ...
                    $sql1="select * from course_document where course_id=".$cid." AND status='Active' order by document_id desc";
                  $result1 = $con->query($sql1);
                 if ($result1->num_rows > 0) {

                while($row1 = $result1->fetch_assoc()) 
                  {
                    $path="controller/course_document/".$row1["document_path"];
        ...
        <h6 class="" align="center"><?php echo $row2["course_name"] ?></h6>
        <img src="document.png" height="50" width="50" align="center">
        <p class="pl-2 pb-4"> <b>Date: <?php echo $row1["upload_date"]?> <br>
            Title : <?php echo $row1["document_title"]?><br>
            Description : <?php echo $row1["document_description"]?><br>
            Download :<a href="<?php echo $path?>" style="color: blue;" download><?php echo $row1["document_path"] ?></a></b>
        </p>     
    </div>
                    <?php
                }
            ...
            <div class="container">
                <table align="center" style="width:100%;font-size:20px;">
                    <tr align=center>
                        ...
                        <td><a href="documents.php?rid=<?php echo $rid ?>"><i class="icofont-folder-open pl-1 active"><span style="font-size:12px;"><p class="f">Document</p></span></i></a></td>
