...
<html lang="en">
    <head>
     ...
     <body>
        ...
        <main id="main">
            <div class="container" >
              ...
              //echo "connection  success";
                    ...
                    $sql1="select * from submit_work where student_id=".$rid." order by lecture_video_id desc";
                  $result1 = $con->query($sql1);
                 if ($result1->num_rows > 0) {

                while($row1 = $result1->fetch_assoc()) 
                  {
                    $path="submission/".$row1["video_path"];
        ...
        <h6 class="" align="center"><?php echo $row1["video_title"] ?></h6>
        <img src="document.png" height="50" width="50" align="center">
        <p class="pl-2 pb-4"> <b>Date: <?php echo $row1["upload_date"]?> <br>
            Title : <?php echo $row1["video_title"]?><br>
            Description : <?php echo $row1["video_description"]?><br>
            Download :<a href="<?php echo $path?>" style="color: blue;" download><?php echo $row1["video_path"] ?></a></b>
        </p>     
    </div>
                    <?php
                }
