...
<div class="text-center">
  <h4>Add Test</h4>
  <form method="post" action="add_test.php" id="course_form" enctype="multipart/form-data">

     <input type="hidden" name="mp_id" id="mp_id">
    <div class="form-group mb-3">
      <input type="text" class="form-control" name="e_name" id="e_name" placeholder="exam title">
    </div>
     <div class="form-group mb-3">
      <input type="text" class="form-control" name="s_name" id="s_name" placeholder="subject name">
    </div>
     <div class="form-group mb-3">
      <input type="number" class="form-control" name="noofqes" id="noofqes" placeholder="no of questions">
    </div>
    <div class="form-group mb-3">
      <input type="number" class="form-control" name="marks" id="marks" placeholder="total marks">
    </div>
     <div class="form-group mb-3">
      <input type="number" class="form-control" name="e_duration" id="e_duration" placeholder="exam timing in hour">
    </div>
    <!--
     <div class="form-group mb-3">
...
-->
    ...
    <div class="text-right">
      <input type="button" class="btn btn-success btn-sm" value="Create Course" onclick="add_course()">
    </div>
   ...
   <script type="text/javascript">
     function add_course()
     {
      ...
      else if(document.getElementById("s_name").value=="")
      {
        alert("please enter subject name");
      }
      else if(document.getElementById("noofqes").value=="")
      {
        alert("please enter number of questions");
      }
      else if(document.getElementById("marks").value=="")
      {
        alert("please enter exam total marks");
      }
      else if(document.getElementById("e_duration").value=="")
      {
        alert("please enter exam time in houres");
      }
      else
      {
        var frm=document.getElementById("course_form");
        frm.submit();
      }
