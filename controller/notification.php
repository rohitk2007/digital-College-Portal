...
<div class="text-center">
  ...
  <form method="post" action="add_notification.php" id="course_form" enctype="multipart/form-data">

     <input type="hidden" name="mp_id" id="mp_id">
    <div class="form-group mb-3">
      <textarea class="form-control" name="c_name" id="c_name" placeholder="Notification text" rows="8"></textarea>
    </div>

    <div class="text-right">
      <input type="button" class="btn btn-success btn-sm" value="Send Notification" onclick="add_course()">
    </div>
