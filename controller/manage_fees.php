...
<head>
  ...
  <title>DLLP | Manage Submission</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Manage Submission</h1>
          </div><!-- /.col -->
...
<div class="row">
      ...
      <table class="table">
        ...
        <tbody id="myTable">
          ...
          <?php
              ...
              $sql="select * from submit_work order by lecture_video_id desc";
            ...
            while($row = $result->fetch_assoc()) 
              {
                $pid=$row["student_id"];
                 $path="../submission/".$row["video_path"];
          ...
          <td>
          <?php
           $sql1="select * from course_registration where registration_id=".$pid."";
          ...
          <td>
            <a href="<?php echo $path?>" style="color:white;" download class="btn btn-sm btn-success" >View Document</a>
         ...
         <?php
           ...
           else
           {
            ?>
             ...
             <h6 class="text-danger">No fees found</h6>
  ...
  <!-- /.content-wrapper -->
<form method="post" action="product_status.php" id="updateform">
...
<script type="text/javascript">
    function manage_fees(pid)
    {
      //alert(pid);

      document.getElementById('pid').value=pid;
      document.getElementById('actionid').value="activate";
