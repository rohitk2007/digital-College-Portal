...
<div class="col col-md-6 col-lg-6 m-2">
  ...
  <form method="post"  id="gallery" enctype="multipart/form-data">
    ...
    <div class="text-center">
      <input type="button" class="btn btn-success btn-sm" value="Upload Slider" onclick="upload_lecture()">
   ...
   <script type="text/javascript">
     ...
     function upload_lecture()
     {
      ...
      if(document.getElementById("gallery_file").value=="")
      {
        alert("plese select slider file to upload");
      }
      else
      {
        var frm=document.getElementById("gallery");
        frm.action="add_slider.php";
        frm.submit();
      }
     }
