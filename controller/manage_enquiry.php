...
<head>
  ...
  <title>DLLP | Manage Enauiry</title>
...
<div class="row">
      <table class="table">
        <thead class="thead">
          <tr>
            <td colspan="7" align="center"><h2>Enquiry List</h2></td>
          </tr>
         ...
         <?php
           ...
           else
           {
            ?>
             ...
             <h6 class="text-danger">No Enquiry found</h6>
...
<script type="text/javascript">
    ...
    function manage_product_deactive(pid)
    {
      ...
      document.getElementById('pid').value=pid;
      document.getElementById('actionid').value="deactivate";
      document.getElementById('actiontable').value="main";
      var frm=document.getElementById('updateform');
      frm.submit();
    }
    ...
    function sub_manage_product_active(pid)
    {
      //alert(pid);
      document.getElementById('pid').value=pid;
      document.getElementById('actionid').value="activate";
      document.getElementById('actiontable').value="sub";
      var frm=document.getElementById('updateform');
      frm.submit();
    }

    function sub_manage_product_deactive(pid)
    {
