...
<head>
  ...
  <title>DLLP | Manage Course</title>
...
<div class="row">
      <table class="table" >
        <thead class="thead">
          <tr>
            <td colspan="6" align="center"><h2>course list</h2></td>
          </tr>
        ...
        <tbody id="myTable">
          ...
          <td><input type="button" class="btn btn-sm btn-success" name="" value="Activate" onclick="manage_course_active('<?php echo $cid?>')">
              <input type="button" class="btn btn-sm btn-danger ml-2" name="" value="De-activate" onclick="manage_course_deactive('<?php echo $cid?>')">
              <input type="button" class="btn btn-sm btn-warning ml-2" name="" value="Edit info" onclick="manage_course_update('<?php echo $cid?>')">
          </td>
         ...
         <?php
           ...
           else
           {
            ?>
             ...
             <h6 class="text-danger">No Course found</h6>
  ...
  <!-- /.content-wrapper -->
<form method="post" action="course_status.php" id="updateform">
  <input type="hidden" name="cid" id="cid">
  <input type="hidden" name="actionid" id="actionid">
  <input type="hidden" name="actiontable" id="actiontable">

</form>
<form method="post" action="update_course.php"  id="updatecourse">
...
<script type="text/javascript">
    function manage_course_active(pid)
    {
      //alert(pid);
      document.getElementById('cid').value=pid;
    ...
    function manage_course_deactive(pid)
    {
    ...
    function manage_course_update(pid)
    {

      document.getElementById('ucid').value=pid;
      
      var frm=document.getElementById('updatecourse');
      frm.submit();
    }
  </script>
 <script>
