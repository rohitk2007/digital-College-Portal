     ...
     <body>
        ...
        <main id="main">
            <div class="container" style="color: black" >
                <caption class="mt-3">Available Test Exam</caption>
                <div>
              ...
              $sql="select * from test where status='Active' order by test_id desc";
            ...
            while($row = $result->fetch_assoc()) 
              {
                ...
                $linkp="practice_test.php?rid=".$rid."&testid=".$row["test_id"];
                
                        ?>
                        
                       <div class="mt-2 pt-2" style="background-color:#A6ACAF ;color:black">
        <h6 class="" align="center"><b><?php echo $row["exam_title"]?></b> </h6>
        <p class="text-right pr-2">
            <b><?php echo $row["create_date"]?></b>
        </p>
        <p class="pl-2 pb-4">
            <b> 
            Subject :<?php echo $row["subject_name"]?><br>
        ...
        <div class="text-right pb-3 mr-3 ml-3">
            <a href="<?php echo $linkp ?>" class="btn btn-sm btn-dark ">Practice Test</a>
            <a href="<?php echo $link ?>" class="btn btn-sm btn-dark ">Start Test</a>
        </div>
